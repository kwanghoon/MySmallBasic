package com.conducation.smallbasic.yapbconfig;
...
public class YapbConfigManager {
	...
	String rootPath = System.getProperty("user.dir"); // 현재 프로젝트 경로 가져오기
	...
	public String getConfigFile(BufferedReader br) {
		File configFile = new File(rootPath + "../../yapb.config");
		String configData = "";
	...
	public void printConfigFile(String configData) {
		...
		try {
			writer = new BufferedWriter(new FileWriter(rootPath + "../../yapb.config")); // 파일이 있을경우 덮어쓰기
